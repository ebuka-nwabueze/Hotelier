...
import { createTicket, reset, selectTicket } from "../features/tickets/ticketSlice";
...
function NewTicket() {
  ...
  const {tickets,ticket,isError,isSuccess,isLoading,message} = useAppSelector(selectTicket )
  ...
  type EventType = React.ChangeEvent<HTMLInputElement> | React.ChangeEvent<HTMLSelectElement>
      ...
      <section className="form-content-main">
        <form onSubmit={onSubmit}>
          ...
          <div className="form-group">
            ...
            <select name="category" value={category} id="category" onChange={inputChange}>
